...
class Console
  ...
  def player_symbol
    @io.print_output("X vs. O can be a little predictable. Would you like to pick a different symbol for your opponent?")
  end
  ...
  def already_taken
    @io.print_output("Oops. Can't do that. Please choose one of the spaces that is available on the board.")
  end

  def forfeit
    @io.print_output("You are really not ready for this game. Come back when you are serious.")
  end
